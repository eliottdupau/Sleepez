...
import com.androidapp.sleepez.databinding.ActivityCreateAlarmBinding;
...
public class CreateAlarmActivity extends AppCompatActivity {
    ...
    private void initAlarm() {
        ...
        alarm.strRingtone = RingtoneManager.getRingtone(this, Uri.parse(alarm.uriRingtone)).getTitle(this);
    }
